...
const ladderCaseData = reactive(<CaseData[]>[
  {
    ...
    caseStudy: [
      '龚同学本科毕业于美国排名100名以外的学校，大三大四的时由于患有抑郁症导致全科成绩滑铁卢，毕业的时候只有GPA2.6，对名校已经放弃追求的他，通过亲戚介绍重燃希望找到我们。在了解了鹿名“世界名校直通车”后，龚同学研究生想选择在离中国比较近的地区就读，于是我们推荐了香港大学的低门槛保录取给他。拿到offer时龚同学喜出望外，印象深刻的是曾患有抑郁症且性格腼腆的龚同学，竟然给了负责其申请的顾问老师一个大大的拥抱。希望他在香港大学里能摆脱内心的阴霾，走上灿烂的人生道路。',
    ],
  },
  {
  ...
  },
  {
    ...
    caseStudy: [
      '张同学本科在全英排名五十多的一所大学，由老客户推荐找到我们的时候由于本科成绩较低，不具备GRE分数，本来已经不抱希望了，已经准备好回国工作了。在详细了解鹿名“世界名校直通车”后，决定与我们签约。印象特别深的是收到录取通知书的时候他的那句“这可能是我遇到过的最幸运的事了吧”，但其实就像我们一直说的那样，在我们这里，成功从来不是因为幸运，而是因为你找到了我们，所以必然如此。',
    ],
  },
]);

const incubationCaseData = reactive(<CaseData[]>[
  {
    ...
    caseStudy: [
      '孟同学在11年级之前的暑假找到我们，当时他的学习成绩不错，属于次优等生，但距离申请美国前15名的顶尖大学还是有一定距离的。但是可喜的是，孟同学在初期沟通的过程中明确表示自己的学习积极性很高，渴望在申请大学的过程中不断学习新的知识，提高自己的能力，同时也渴望有“引路人”，可以帮助他确保进入美国前15名的大学。所以根据孟同学的需求，顾问老师给孟同学推荐了独家的“名校教授培养计划”。孟同学在了解到名校教授培养计划详细情况后，很高兴的接受了。',

      '“星辰计划”初期我们首先要了解学生的兴趣爱好，特长，以及未来理想的事业目标，从而来制定整个培养计划。简单来说孟学生比较喜欢策略型游戏，对商业很感兴趣，父母也都是商人，尤其是数学能力比较突出。',

      '因此，在了解孟同学的具体情况的后，“名校教授培养计划”的在职教授团队制定了详细的培养方案，全覆盖式辅导孟同学，综合提升学生的背景竞争力的同时兼顾学术成绩的提高。',
      '在六位权威教授的努力下，通过多个项目全方未提升学生的综合竞争力，包括康奈尔大学暑期课程，拿全A，并获得其教授推荐信；参加高含金量的商科竞赛以及数学竞赛并获奖；参加并成功完成哈佛大学经济金融学科研项目；并且参加了谷歌暑期实习项目等；',
      '名校教授培养计划让孟同学从一开始的腼腆，变成一个谈笑风生，无比自信的人。加强了背景竞争力的同时，学术水平也有了长足进步。更重要的是，孟同学在教授的代领下找到了自己的兴趣所在，确定了自己未来想从事的事业，有了每天能为之努力的明确目标。孟同学也在老师合理的规划下，和六位权威教授共同度过了一年的美好时光，最终获得理想成绩，进入了最理想的院校。',
    ],
  },
  {
    imgLink: 'incubation-case-1.png',
...
const cloudCaseData = reactive(<CaseData[]>[
  {
    ...
    caseStudy: [
      ...
      '但陆同学从小就有藤校情结，坚持只选择美国常春藤大学。于是我们给陆同学推荐了鹿名国际的“世界名校直通车”，精准录取康奈尔大学，而且只用申请这一所学校。获知此方案后，陆同学的父亲陆总对如此“完美”的方案不敢相信，前前后后沟通了不下10次，最终要求我们必须接受“公平对赌条款”（对赌一定数量金额，不录取赔付客户，录取则客户多支付其金额）才与我们签约。我们对自己方案有100%的信心，于是便答应下来。',
...

  {
    ...
    caseStudy: [
      '马同学，在20年申请季的时候找到我们，本科在地处曼哈顿佩斯大学的她，很喜欢纽约这座城市，并且对纽约最好的大学-哥伦比亚大学钟情许久。所以她的目标很明确，非哥伦比亚大学莫属。所以我们推荐了鹿名“世界名校直通车”中，哥伦比亚大学商学院单所精准录取项目。',
...
export default function (props: propsType) {
  currentType.value = props.programType;
