...
export default {
    ...
    setup() {
        ...
        const carouselData = ref < CarouselData[] > ([{
                ...
                title: '产品特点',
                subTitle: '短时间',
                description: '传统留学中介和咨询公司通常需要学生提前半年至两年的时间开始准备申请工作，而鹿名青云计划只需要学生距离申请截止日期一个月便可以确保申请流程高效且高质量顺利完成',
                imgLink: 'oxford.jpeg',
            },
            {
                name: '',
                title: '产品特点',
                subTitle: '低分高录',
                description: '和其他留学和中介公司不同的是，鹿名学员不需要自身成绩和背景多么优秀，也不需要后续参加任何成绩和背景提升的额外培训，鹿名能够保证学员进入比其自身条件更高的名校',
                imgLink: 'lb.jpg',
            },
            {
                name: '',
            ...
            },
            {
                ...
                title: '产品特点',
                subTitle: '独家资源',
                description: '随着多年以来的积累，鹿名凝聚着最核心、最顶尖的国际名校招生官、校董、校园管理层、名师以及资源。这些独有的资源渠道是鹿名青云计划短时间帮助学员完成申请、低分高录、名校精准保录的最坚实保障',
                imgLink: 'bg.jpg',
            },
        ]);
        return {
