          ...
          >
            <div class="row">
              <div class="col-12">
                ...
                <ul class="area">
                  <li
                    :class="['label', slideOffer == 'offer0' ? 'active' : '']"
                  >
                    美国藤校
                  </li>
                  <li
                    :class="['label', slideOffer == 'offer1' ? 'active' : '']"
                  >
                    英国前五
                  </li>
                  <li
                    :class="['label', slideOffer == 'offer2' ? 'active' : '']"
                  >
                    澳洲八大
                  </li>
                  <li
                    :class="['label', slideOffer == 'offer3' ? 'active' : '']"
                  >
                    新加坡名校
                  </li>
                </ul>
