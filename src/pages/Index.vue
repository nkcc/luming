  ...
  <q-page>
      ...
      <div class='lm-points row items-center lg:container lg:mx-auto'>
        <div class='points-container '>
          <q-carousel v-model='slide' transition-prev='scale' transition-next='scale' swipeable animated
                      control-color='secondary' navigation padding arrows class='lm-points-background' keep-alive
    ...
    <section class='lm-culture  lg:container lg:mx-auto'>
      ...
      <div class='row q-col-gutter-sm'>
        ...
        <div class='col col-sm-6 col-xs-12 col-md-3 culture-item' v-for='(v, k) in cultureData' :key='k' :data-id='k'
        ...
        <div class='offer-container'>
          <div class='row'>
            <div class='col-12 q-pa-xs-xs'>
              ...
              <ul class='area'>
                <li :class="['label', slideOffer === v.type ? 'active' : '']" v-for='(v, k) in offerType' :key='k'
                    @click='changeSlideOfferType(v.type)'>
                  {{ v.title }}
                </li>
              </ul>
            </div>
          </div>
          <q-carousel v-model='slideOffer' control-color='white' navigation padding arrows animated
    ...
    <section class='lm-case'>
      <div :class="[
        ...
        <div class='row justify-center items-center items-stretch lg:container lg:mx-auto'
             :class="k % 2 !== 0 ? 'reverse' : ''">
