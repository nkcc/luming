...
<q-page class="row items-center justify-evenly">
    ...
    <section class="lm-points">
        <q-carousel v-model="slide" transition-prev="scale" transition-next="scale" swipeable animated control-color="white" navigation padding arrows class="lm-points-background" keep-alive :keep-alive-include="'carousel0, carousel1, carousel2, carousel3'">
            >
            ...
            <template v-for="(v, k) in carouselData" :key="k">
                <q-carousel-slide :name="'carousel' + k" class="column no-wrap flex-center">
                    <div class="row">
                ...
                <q-carousel-slide :name="'offer' + k" class="column no-wrap flex-center">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <ul class="area">
                                <li :class="['label', slideOffer == 'offer0' ? 'active' : '']">
                                    美国藤校
                                </li>
                                <li :class="['label', slideOffer == 'offer1' ? 'active' : '']">
                                    英国前五
                                </li>
                                <li :class="['label', slideOffer == 'offer2' ? 'active' : '']">
                                    澳洲八大
                                </li>
                                <li :class="['label', slideOffer == 'offer3' ? 'active' : '']">
                                    新加坡名校
                                </li>
                            </ul>
                        </div>
    ...
    <section class="lm-team lm-dark-background">
        ...
        <div class="team-container row">
            <div class="team-card col-3" v-for="(v, k) in teamData" :key="k">
