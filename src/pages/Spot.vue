    ...
    <section class="lm-culture-points lm-light-dark-background">
      <div class="lg:container lg:mx-auto">
        ...
        <div class="lm-spot row justify-center pb-14">
          <div
            class="spot-container col-9 col-xs-12 col-md-9 flex items-center pb-24 q-px-xs-md q-px-md-none"
            :class="[k !== 0 ? 'pt-24' :'', k === spotData.length - 1 ? 'last' : '']"
          ...
          >
            <div class="row items-center" :class=" k % 2 === 0 ? '' : 'reverse'">
              <div class="col-6 col-xs-12 col-md-7 self-start">
                ...
                <p
                  class="spot-description text-white text-lg pb-2 leading-7"
