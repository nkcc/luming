...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      {
        path: 'incubation/:id',
        component: () => import('pages/IncubationProgram.vue'),
      },
      {
        path: 'incubation',
        component: () => import('pages/IncubationProgram.vue'),
      ...
      {
        path: 'famous-school-car',
        component: () => import('src/pages/FamousSchoolCar.vue'),
      },
      { path: 'ladder', component: () => import('pages/LadderProgram.vue') },
      {
        path: 'academic/:id',
        component: () => import('pages/AcademicManager.vue'),
        props: true,
      },
      {
        path: 'academic',
